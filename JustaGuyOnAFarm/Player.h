...
public:
	...
	bool reachingPlaceForMapChange(float lowerTransitionPointX, float higherTransitionPointX, float lowerTransitionPointY, float higherTransitionPointY, float mapSizeX, float mapSizeY);
};
